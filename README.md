...
[![medRxiv](https://img.shields.io/badge/medRxiv-Preprint-b31b1b)](https://medrxiv.org/cgi/content/short/2026.05.15.26353325v1)
...
**Chinthala LK.** *Real-World Validation of Machine Learning Models for HIV Treatment Adherence Prediction and Care Gap Quantification: Validation on 27,288 Nigerian HIV Programme Records.* medRxiv. 2026.

🔗 **Preprint:** [https://medrxiv.org/cgi/content/short/2026.05.15.26353325v1](https://medrxiv.org/cgi/content/short/2026.05.15.26353325v1)

🔖 **DOI:** [10.64898/2026.05.15.26353325](https://doi.org/10.64898/2026.05.15.26353325)

> *This preprint has not been peer-reviewed. Results are preliminary and subject to revision.*
...
> *Manuscript in preparation. DOI will be added upon submission.*
...
> *Screenshots will be added following pilot deployment.*

### Programme Dashboard
![Programme Dashboard](images/dashboard_overview.png)

### Patient Risk Stratification
![Patient Risk](images/patient_risk.png)

### SHAP Explainability — Per-Patient Waterfall
![SHAP Waterfall](images/shap_waterfall.png)

### Facility Intelligence
![Facility Intelligence](images/facility_intelligence.png)
...
| Cross-validation AUC | 0.963 | 10-fold stratified CV — optimistic in-sample estimate |
...
### Discovery Cohort
27,288 HIV-positive patients on ART from the Nigerian national HIV programme (Quality of Care dataset, 2006–2018).
...
Treatment Adherence Prediction and Care Gap Quantification: Validation
on 27,288 Nigerian HIV Programme Records. medRxiv. 2026.
DOI: 10.64898/2026.05.15.26353325
```
...
| 📄 Preprint | [medRxiv 10.64898/2026.05.15.26353325](https://medrxiv.org/cgi/content/short/2026.05.15.26353325v1) |
