...
> SmartDaaS is one of only **2 of 13** published machine learning models for HIV treatment retention prediction with any external validation — and the **only one validated across multiple countries** (Kwarah et al., 2025, BMC Global and Public Health; Salami et al., 2026, JMIR Medical Informatics).
