...
**Discovery cohort:** 27,288 HIV-positive patients on ART from the Nigerian national HIV programme (Quality of Care dataset, 2006–2018). This single-country dataset was used to train and validate the base model.

**External validation status:** Multi-country external validation is ongoing through:
- DHS multi-country datasets (South Africa, Uganda, Zambia, Malawi, Kenya) — access requested
...
- PHIA population-based HIV impact assessment datasets — access requested
...
1. **Single-country discovery cohort:** The base model was trained on Nigerian programme data (2006–2018). Performance in other health systems may differ — local recalibration is required.
