...
TRAINING_MEDIANS = {
    ...
    'sex_female':               1.0000,
    'Cd4AtStart':             260.0000,
    'MostRecentCd4Count':     388.0000,
    'CD4_improvement':         54.0000,
...
#
#   HIGH   (>= 0.15) : Sensitivity 27.7%, Specificity 97.0%, PPV 21.9%
#                      flags 3.7% of patients
#   MEDIUM (>= 0.075): Sensitivity 52.4%, Specificity 89.6%, PPV 13.4%
#                      flags 11.6% of patients
#
# Lower the thresholds to catch more patients at the cost of more
# outreach volume. This is a programme capacity decision.
# ─────────────────────────────────────────────────────────────
BASELINE_THRESHOLD = 0.15    # HIGH
MEDIUM_THRESHOLD   = 0.075   # MEDIUM
...
# 15 features, adults 18–100, n=23,144 (850 poor adherence, 3.67%).
# Trained ≤ 2016-09; tested on later initiators (n=6,942).
# 95% CI 0.774–0.837. 10-fold CV on the same cohort: 0.801.
BASELINE_AUC           = 0.806
