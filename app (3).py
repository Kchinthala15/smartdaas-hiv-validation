...
# ═════════════════════════════════════════════════════════════
    ...
    with c3:
        ...
        drivers = []
        for i in top3_idx:
            feat_name = FEAT_LABELS.get(FEATURES[int(i)], FEATURES[int(i)])
            direction = "increases" if pt_sv[int(i)] > 0 else "reduces"
            drivers.append(f"**{feat_name}** {direction} risk (SHAP: {pt_sv[int(i)]:+.3f})")
