...
.stButton > button[kind="primary"]:hover {
    ...
    box-shadow: 0 4px 20px #00e5ff44 !important;
}
...
if page == "🏠 Home":
    ...
    <div style="text-align:center;margin:0.5rem 0 1.5rem 0">
        <p style="color:#8fa0b0;font-size:0.85rem;margin:0 0 0.6rem 0;
        font-family:'IBM Plex Mono',monospace;letter-spacing:1px;text-transform:uppercase">
        Ready to explore the platform?</p>
    </div>""", unsafe_allow_html=True)
    ...
    with cta_cols[1]:
        if st.button("🚀  Launch Dashboard  →",
                     ...
                     type="primary",
                     key="cta_launch"):
            st.session_state["nav_main"] = "❤️ Patient Risk"
            st.rerun()
