...
def check_password():
    ...
    .login-sub { color:#8b949e; font-size:1rem; margin-bottom:2rem; }
    </style>
...
[data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label:nth-child(10) {
    ...
    border-top: 1px solid #21212a !important;
...
.section-hdr { font-family:'IBM Plex Mono',monospace; font-size:0.95rem; color:#21d4fd;
...
.warn-box { background:#1c1208; border-left:3px solid #e3b341; padding:0.75rem 1rem;
    border-radius:0 6px 6px 0; font-size:0.95rem; color:#e3b341; margin:0.75rem 0; }
.success-box { background:#0d1f17; border-left:3px solid #3fb950; padding:0.75rem 1rem;
    border-radius:0 6px 6px 0; font-size:0.95rem; color:#3fb950; margin:0.75rem 0; }
