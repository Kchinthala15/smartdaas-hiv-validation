...
with st.sidebar:
    ...
    st.markdown("""<div class="info-box">
        ...
        Paper 2 → <em>Submitted to BMJ Global Health</em>
    </div>""", unsafe_allow_html=True)
    ...
    if st.button("📄 Generate Executive PDF Report", use_container_width=True, type="primary"):
        with st.spinner("Generating professional PDF report..."):
            try:
                ...
                pdf.set_font('Helvetica', '', 9)
                pdf.set_text_color(173, 186, 199)
                pdf.multi_cell(0, 5, 'Based on Paper 2 analysis of 27,288 patients from the Nigerian national HIV programme (Chinthala 2026, submitted to BMJ Global Health). Findings are directionally consistent with evidence from South Africa (Bor et al. 2021, PLOS Medicine).')
                pdf.ln(4)
