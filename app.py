...
/* Hide ALL radio circles in sidebar — aggressive override */
...
[data-testid="stSidebar"] [data-testid="stRadio"] label[data-checked="true"] {
    ...
    border-left: 3px solid #21d4fd !important;
...
with st.sidebar:
    ...
    def nav_group(label):
        st.markdown(
            ...
            f'letter-spacing:1.5px;padding:10px 0 2px 4px;margin-top:6px;'
