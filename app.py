"""
SmartDaaS MVP v1.0 — HIV Programme Intelligence Platform
Lakshmi Kalyani Chinthala | Golden Gate University
ORCID: 0009-0009-8736-6673

v1.0 additions:
- Intervention Recommendation Engine with clinical reasoning
- PDF Executive Report Generator
- Cohort Intelligence Dashboard
- Decision Intelligence page
- Color/contrast CSS improvements
- Robust CSV upload with column auto-mapping
"""
...
def check_password():
    ...
    <div class="login-container">
        ...
        <div class="login-sub">HIV Programme Intelligence Platform</div>
    </div>
...
<div class="smartdaas-header">
    ...
    <span class="version-tag">v1.0 · Research Prototype · Not for Clinical Use</span>
</div>
""", unsafe_allow_html=True)
...
# ═════════════════════════════════════════════════════════════
    ...
    <br><br><em>SmartDaaS v1.0 requires local validation before operational use.</em>
    </div>""", unsafe_allow_html=True)
...
""")
            ...
            try:
                ...
                class SmartDaaSReport(FPDF):
                    ...
                    def footer(self):
                        ...
                        self.cell(0, 10, f'SmartDaaS v1.0  ·  Research Prototype — Not for Clinical Use  ·  Page {self.page_no()}', align='C')
                ...
                pdf.multi_cell(0, 5, 'IMPORTANT: This report is generated by a research prototype (SmartDaaS v1.0). It is NOT validated for clinical decision-making and should not be used to make individual patient treatment decisions without clinical review. All findings are indicative and require validation on prospective data before programmatic application.')
                ...
                methodology_text = (
                    ...
                    "This platform is a research prototype — not validated for clinical decision-making. "
    ...
    st.markdown("""<div class="warn-box">
    ⚠️ <strong>Research prototype only.</strong> This report is generated by an AI model
...
# ═════════════════════════════════════════════════════════════
    ...
    st.markdown("""
### Model Transparency & Temporal Generalization

**Honest performance documentation for programme managers, donors, and research audiences.**

SmartDaaS does not hide model limitations. This page documents exactly how the model
performs, what temporal validation means, and what is required before operational deployment.
""")

    # ── PERFORMANCE PANEL ─────────────────────────────────
    st.markdown('<p class="section-hdr">Model Performance — Honest Estimates</p>', unsafe_allow_html=True)
...
**How SmartDaaS works with your existing programme — not instead of it.**
""")
    ...
    st.markdown("""<div style="background:linear-gradient(135deg,#161b22,#0d2137);
        ...
        <p style="font-size:1.3rem;color:#21d4fd;font-weight:600;margin:0 0 0.5rem 0">
        Shadow Analytics — Run Alongside, Not Instead Of</p>
        <p style="color:#cdd9e5;margin:0;font-size:1rem;line-height:1.6">
        SmartDaaS does not replace your existing HIV programme reporting workflows.
        It runs in parallel — ingesting the same data exports you already produce,
        generating intelligence that standard spreadsheets and aggregate indicators miss,
        and delivering actionable outputs your team can act on immediately.</p>
    </div>""", unsafe_allow_html=True)
...
- A validated clinical tool (research prototype only)
...
""")
    ...
    st.markdown("""<div class="warn-box">
    ⚠️ SmartDaaS is a research prototype under peer review. It is not validated for clinical
