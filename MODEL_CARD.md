...
**License:** PolyForm Noncommercial 1.0.0 — free for charitable, research, health and government use regardless of funding source; commercial use requires a separate licence. The training data is not covered.
