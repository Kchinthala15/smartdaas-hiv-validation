...
L10N = {
    "English": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS does not stop at risk prediction. ActionLens helps care teams understand why a patient was flagged, what to check next, and how to document the follow-up.",
    ...
    "French": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS ne se limite pas à la prédiction du risque. ActionLens aide les équipes de soins à comprendre pourquoi un patient a été signalé, ce qu'il faut vérifier ensuite, et comment documenter le suivi.",
    ...
    "Swahili": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS haisimami kwenye utabiri wa hatari. ActionLens husaidia timu za huduma kuelewa kwa nini mgonjwa aliwekwa alama, kinachohitaji kuangaliwa baadaye, na jinsi ya kuandika ufuatiliaji.",
    ...
    "Hausa": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS baya tsayawa kawai akan hasashen haɗari. ActionLens na taimaka wa ƴan kungiyoyin kulawa su fahimci dalilin da majiyyaci ya samu alama, abin da za a duba na gaba, da kuma yadda za a rubuta bibiya.",
    ...
    "Yoruba": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS kò dúró ní àsọtẹ́lẹ̀ ewu nìkan. ActionLens ń ràn àwọn ẹgbẹ́ ìtọ́jú lọ́wọ́ láti mọ ìdí tí a fi ṣàmì sí aláìsàn, ohun tí ó yẹ kí a ṣàyẹ̀wò lẹ́yìn náà, àti bí a ṣe lè ṣàkọsílẹ̀ ìtọ́jú náà.",
    ...
    "Igbo": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS akwụsịghị na ịkọ amụma ihe egwu. ActionLens na-enyere ndị otu nlekọta aka ịghọta ihe kpatara e ji mara onye ọrịa, ihe a ga-elele ọzọ, na otu e si edekọ nleba anya.",
    ...
    "Kinyarwanda": {
        ...
        "ui": {
            ...
            "positioning": "SmartDaaS ntigarukira ku guteganya ibyago gusa. ActionLens ifasha itsinda ry'ubuvuzi gusobanukirwa impamvu umurwayi yamenyekanye, icyagombye gusuzumwa, n'uburyo bwo kwandika ikurikirana.",
